        ...
        global $rtp_hooks; ?>
            <table class="form-table">
                <tbody>
                    ...
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_before_content_wrapper"><?php _e( 'Hook Before Content Wrapper', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[before_content_wrapper]" id="rtp_hook_before_content_wrapper"><?php echo $rtp_hooks['before_content_wrapper']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_before_content"><?php _e( 'Hook Before Content', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[before_content]" id="rtp_hook_before_content"><?php echo $rtp_hooks['before_content']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_after_content"><?php _e( 'Hook After Content', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[after_content]" id="rtp_hook_after_content"><?php echo $rtp_hooks['after_content']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_before_post_start"><?php _e( 'Hook Before Post Start', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[before_post_start]" id="rtp_hook_before_post_start"><?php echo $rtp_hooks['before_post_start']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_after_post_end"><?php _e( 'Hook After Post End', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[after_post_end]" id="rtp_hook_after_post_end"><?php echo $rtp_hooks['after_post_end']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
                    ...
                    <tr valign="top">
                        <th scope="row"><p><label for="rtp_hook_after_sidebar"><?php _e( 'Hook After Sidebar', 'rtPanel' ); ?></label></p></th>
                        <td><textarea cols="33" rows="5" name="rtp_hooks[after_sidebar]" id="rtp_hook_after_sidebar"><?php echo $rtp_hooks['after_sidebar']; ?></textarea><br /></td>
                    </tr>
                    <tr valign="top">
