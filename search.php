...
<?php global $rtp_general; ?>
    ...
    <div id="content" role="main" class="rtp-multiple-post<?php echo (  $rtp_general['search_code'] && $rtp_general['search_layout'] ) ? ' rtp-grid-12' : ' rtp-grid-8 rtp-alpha'; ?>"> <!-- content begins --><?php
