 ...
 * Using this widgets Admin can show:
 * 1. Custom Subscribe widget with Social Share
 * 2. Recent Comments with Gravatar
 * 3. Advanced Sidebar Category Widget
 *
 * @package rtPanel
 ...
 */
    ...
    /**
     *  Email Subcription Widget With the Social Icons
     */
...
class rtp_subscribe_widget extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            <?php
                ...
                $target = ( $rt_link_target == 'on' ) ? 'target="_blank"' : '';
                ...
                if ( $rt_facebook_show || $rt_twitter_show || $rt_rss_show || $rt_linkedin_show || $rt_myspace_show || $rt_stumbleupon_show ) { ?>
                    ...
                    <ul class="social-icons"><?php
                        echo isset ( $rt_facebook_show ) ? '<li><a rel="nofollow" ' . $target . ' class="facebook" href="' . $facebook_link . '" title="' . __( 'Follow Us on Facebook', 'rtPanel' ) . '">Facebook</a></li>' : '';
                        echo isset ( $rt_twitter_show ) ? '<li><a rel="nofollow" ' . $target . ' class="twitter" href="' . $twitter_link . '" title="' . __( 'Follow Us on Twitter', 'rtPanel' ) . '">Twitter</a></li>' : '';
                        echo isset ( $rt_rss_show ) ? '<li><a rel="nofollow" ' . $target . ' class="rss" href="' . $rss_link . '" title="' . __( 'Follow Us on RSS', 'rtPanel' ) . '">RSS</a></li>' : '';
                        echo isset ( $rt_linkedin_show ) ? '<li><a rel="nofollow" ' . $target . ' class="linkedin" href="' . $linkedin_link . '" title="' . __( 'Follow Us on LinkedIn', 'rtPanel' ) . '">LinkedIn</a></li>' : '';
                        echo isset ( $rt_myspace_show ) ? '<li><a rel="nofollow" ' . $target . ' class="myspace" href="' . $myspace_link . '" title="' . __( 'Follow Us on MySpace', 'rtPanel' ) . '">MySpace</a></li>' : '';
                        echo isset ( $rt_stumbleupon_show ) ? '<li><a rel="nofollow" ' . $target . ' class="stumbleupon" href="' . $stumbleupon_link . '" title="' . __( 'Follow Us on StumbleUpon', 'rtPanel' ) . '">StumbleUpon</a></li>' : ''; ?>
                    </ul><?php
                } ?>
                <div class="clear"></div>
    ...
    <?php echo $after_widget;
        ...
        function form( $instance ) {
            ...
            $rt_link_target = !empty(  $instance['rt_link_target'] ) ? $instance['rt_link_target'] : '';
            $defaults = array( 'rt_show_subscription' => '1', 'rt_show_rss' => '1', 'rt_show_facebook' => '1', 'rt_show_twitter' => '1', 'rt_show_linkedin' => '1', 'rt_show_myspace' => '1', 'rt_show_stumbleupon' => '1', 'rt_link_target' => '1' );

            // update instance's default options
            $instance = wp_parse_args( (array) $instance, $defaults );
            $rt_show_subscription = isset ( $instance['rt_show_subscription'] ) ? 1 : '' ;
            $rt_show_rss = ( isset ( $instance['rt_show_rss'] ) ) ? 1 : '';
            $rt_show_facebook = ( isset ( $instance['rt_show_facebook'] ) ) ? 1 : '';
            $rt_show_twitter = ( isset ( $instance['rt_show_twitter'] ) ) ? 1 : '' ;
            $rt_show_linkedin = ( isset ( $instance['rt_show_linkedin'] ) ) ? 1 : '';
            $rt_show_myspace = ( isset ( $instance['rt_show_myspace'] ) ) ? 1 : '';
            $rt_show_stumbleupon = ( isset ( $instance['rt_show_stumbleupon'] ) ) ? 1 : ''; ?>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_subscription' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_subscription' ); ?>" <?php checked( $rt_show_subscription ); ?> />
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_rss' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_rss' ); ?>" <?php checked( $rt_show_rss ); ?> />
                <label for="<?php echo $this->get_field_id( 'rss_link' ); ?>"><?php _e( 'RSS Feed Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_facebook' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_facebook' ); ?>" <?php  checked( $rt_show_facebook ) ; ?> />
                <label for="<?php echo $this->get_field_id( 'facebook_link' ); ?>"><?php _e( 'Facebook Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_twitter' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_twitter' ); ?>" <?php checked( $rt_show_twitter ) ; ?> />
                <label for="<?php echo $this->get_field_id( 'twitter_link' ); ?>"><?php _e( 'Twitter Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_linkedin' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_linkedin' ); ?>" <?php checked( $rt_show_linkedin ); ?> />
                <label for="<?php echo $this->get_field_id( 'linkedin_link' ); ?>"><?php _e( 'LinkedIn Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_myspace' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_myspace' ); ?>" <?php checked( $rt_show_myspace ); ?> />
                <label for="<?php echo $this->get_field_id( 'myspace_link' ); ?>"><?php _e( 'MySpace Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input type="checkbox" name="<?php echo $this->get_field_name( 'rt_show_stumbleupon' ); ?>" value="true" id="<?php echo $this->get_field_id( 'rt_show_stumbleupon' ); ?>" <?php checked( $rt_show_stumbleupon ); ?> />
                <label for="<?php echo $this->get_field_id( 'stumbleupon_link' ); ?>"><?php _e( 'StumbleUpon Link', 'rtPanel' ); ?>: </label>
            ...
            <p>
                <input name="<?php echo $this->get_field_name( 'rt_link_target' ); ?>" type="hidden" value="off" />
                <input class="link_target" id="<?php echo $this->get_field_id( 'rt_link_target' ); ?>" value="on" name="<?php echo $this->get_field_name( 'rt_link_target' ); ?>" type="checkbox" <?php checked( 'on', $rt_link_target ); ?> />
...
class rtp_category_widget extends WP_Widget {
            ...
            function widget( $args, $instance ) {
                ...
                $show_cat = !empty( $instance['show_cat'] ) ? $instance['show_cat'] : 5;
    ...
    /**
     * Register All widgets in this Template
     */
